...
The **Result** tab shows the readable outcome, returned IDs, documents, and the next useful action. Asynchronous report/feed/inbound flows provide a simple **Next step** button. If Amazon returns several label/document URLs, all of them remain selectable.
